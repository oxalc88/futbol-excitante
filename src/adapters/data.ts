...
export const DEFAULT_TACTICS: Tactics = { formation: '4-3-3', defensiveLine: .52, compactness: .65, pressing: .6, tempo: .65, width: .7, support: .6, buildUp: .55, counterPress: .5, shortPossession: .3, tightMarking: .3, adaptation: .5 };
const agile: Capabilities = { speed: 8.6, acceleration: 6.8, braking: 9, turnRate: 5.8, control: .91, passing: .8, finishing: .72, power: 27, physical: 64, balance: .93, stamina: .9, tackling: .6, curve: .8, weakFoot: .75, keeper: .2, heading: .75, jump: .55 };
const strong: Capabilities = { speed: 7.2, acceleration: 4.4, braking: 7.2, turnRate: 3.5, control: .71, passing: .73, finishing: .67, power: 31, physical: 90, balance: .7, stamina: .85, tackling: .86, curve: .5, weakFoot: .6, keeper: .2, heading: .86, jump: .48 };
...
export function validateTeam(input: unknown): TeamProfile {
  const t = structuredClone(input) as TeamProfile;
  ...
  if(t.tactics) t.tactics={...DEFAULT_TACTICS,...t.tactics};
