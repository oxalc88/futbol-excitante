...
const RULES: GateRule[] = [
  ...
  { name: "shared GLM scheduling policy is explicit", file: "gauntlet/runtime-policy.json", mustContain: ["nan/glm5.3-flash", "orchestrator-glm", "critic", "integration-reviewer", "\"soft_limit_input_tokens\": 675000", "\"rolling_window_ms\": 60000", "\"maximum_failures\": 5"] },
  { name: "bounded memory and continuation remain non-authoritative", file: "gauntlet/memory-context-contract.md", mustContain: ["never preload", "maximum five previews", "maximum three topics", "not authoritative", "old conversation"] },
  { name: "runtime efficiency preserves review and acceptance", file: "gauntlet/runtime-efficiency-contract.md", mustContain: ["does not change builder independence", "terminal event wakes the parent once", "queued wake", "fresh builder", "does not skip checks"] },
  ...
  { name: "semver system version is declared", file: "gauntlet/VERSION.json", mustContain: ["\"version\": \"0.9.7\"", "\"previous_system_version\": \"0.9.6\"", "\"semver\": true", "provider-failure-resilience", "equivalent-orchestrator-continuation", "event-driven-child-waiting", "shared-glm-tpm-admission", "bounded-project-memory", "builder-phase-rotation", "usage-effectiveness-telemetry"] },
