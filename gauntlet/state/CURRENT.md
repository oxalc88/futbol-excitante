...
selection_note: "Horizon v25 (restart-flow-human-arc-and-duels-rerun) COMPLETE 4/4 — EXHAUSTED; strategic replan next. (1) RESTART-ANTI-HUDDLE-COHERENCE ACCEPTED (candidate 210b27c, acceptance 9ec8c98): restarts follow the freeze-until-first-touch + nearest-only contract across corner/throw-in/goal-kick/post-goal. (2) HUMAN-VS-CPU-ARC-INTERACTION ACCEPTED (candidate 6db29f2): human interacts with the arc as browser DYNAMIC_VISUAL evidence (5 frames + sequence.json + 720-tick trajectory). (3) DUELS-SUITE-ORGANIC-RERUN ACCEPTED (candidate 8756cbe): honest duels-suite refresh over organic observations — TACK-ST-001-PHASE / TACK-SL-001-PHASE / PHY-SHLD-001-CONT organic PASS, PHYSICAL_DUEL now present organically; protected COMMON FAILs unchanged; critic ACCEPT after 1 provenance RETRY. (4) VIDEO-CAPTURE-RESTORE-30S-CLIP ACCEPTED (candidate 0f63f92): capture-ai-video tool restored (Playwright-native WebM, no ffmpeg) + real ~36 s clip of the accepted anti-huddle 5v5 arc as optional diagnostic evidence; critic+integration ACCEPT first pass. GK/regulation/full-match/perceptual-rubric/networked/PES-fidelity remain deferred."
```
