...
next_objective_id: GK-SPEC-SUITE-CONTRACTS


best_known:
  commit: 0f63f92
  note: "VIDEO-CAPTURE-RESTORE-30S-CLIP accepted (Horizon v25 4/4 — horizon COMPLETE) — repository video path restored. scripts/capture-ai-match-video.mjs (the missing capture-ai-video target) recreated as a Playwright Chromium NATIVE recordVideo tool (WebM; system ffmpeg genuinely absent — probed and honestly skipped; WIP_SECTION evidence gate; ordinary runs leave docs/ byte-identical). Real ~36 s clip of the accepted anti-huddle 5v5 arc (ai-match-5v5, cpuAntiHuddle:true, sim tick 900): 1,125,058 bytes, SHA-256 575ff1140de82f97128ed0029a4ec5a304d74f9f99950e389c62fe922f0c4fd3 (independently recomputed by critic + integration; EBML magic verified); binary optional/ephemeral per evidence-manifest-contract; durable committed record = video-meta.json + video-reference.json (provider/artifact/dates/candidate 0f63f92). Binding test 5/5 incl. real 2 s Chromium run asserting metadata-vs-file honesty. Zero gameplay change (git diff src/simulation/ src/contracts/ eval/runners/ eval/scenarios/ specs/ EMPTY). Critic (glm5.3-flash) ACCEPT first pass; integration ACCEPT first pass (9/9 neighbors, typecheck 0, vite build OK). Audit PASS 20/20 HEADLESS. Video is optional diagnostic evidence and never replaces trajectories/frames."
...
selection_note: "Horizon v26 (goalkeeper-arc-small-sided) ACTIVE 0/4 - created 2026-09-05 after Horizon v25 COMPLETE 4/4 (remote-durable at 5829156). The objective catalog gates the REGULATION milestone behind dedicated goalkeeper/rules specs and AGENTS.md defers goalkeepers until their dedicated specs and suites exist - so v26 opens the bounded small-sided GK arc: (1) GK-SPEC-SUITE-CONTRACTS - dedicated GK spec + versioned evaluator suite contracts, spec+contracts only, missing references stay BLOCKED_MISSING_REFERENCE (builder-structured); (2) GK-5V5-ADAPTER-BEHAVIOR - designated-keeper hold/save behavior at the adapter/team-decision layer with MULTI_TICK evidence + stashed control (builder-gameplay); (3) GK-BROWSER-DYNAMIC-EVIDENCE - browser DYNAMIC_VISUAL of GK positioning + save/claim (builder-gameplay); (4) GK-SUITE-ORGANIC-STATE - honest organic GK-suite state re-run (builder-structured). Horizon v25 (restart-flow-human-arc-and-duels-rerun) COMPLETE 4/4: RESTART-ANTI-HUDDLE-COHERENCE (210b27c/9ec8c98), HUMAN-VS-CPU-ARC-INTERACTION (6db29f2/fee70eb), DUELS-SUITE-ORGANIC-RERUN (8756cbe/177e637), VIDEO-CAPTURE-RESTORE-30S-CLIP (0f63f92/5829156). GK/regulation/full-match/perceptual-rubric/networked/PES-fidelity remain deferred beyond the bounded GK-arc objectives."
```
