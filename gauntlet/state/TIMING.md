...
measured_at: 2026-08-22T11:33:55Z
tracking_contract_version: 1
last_tracked_objective: ARCHETYPE-FULL-PAIR-RECAPTURE
usage_aggregates_through: ARCHETYPE-FULL-PAIR-RECAPTURE
clock_aggregates_through: ARCHETYPE-FULL-PAIR-RECAPTURE
model_evaluation_through: ARCHETYPE-FULL-PAIR-RECAPTURE
...
| | Duration |
|---|---:|
| Calendar span (first work → measurement) | 41h 34m |
| Unexplained stop (excluded) | 5h 16m |
| Active work (anything running) | 36h 12m |
| Sum of per-step agent time | 28h 32m |
| Orchestrator thinking between steps | ~12h 48m |

Session start: `2026-08-14 01:19 UTC`. Measurement: `2026-08-22T11:33:55Z`.
