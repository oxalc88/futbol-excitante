...
measured_at: 2026-09-07T13:36:00Z
tracking_contract_version: 1
last_tracked_objective: FULLTIME-FLOW-CLOSURE
usage_aggregates_through: FULLTIME-FLOW-CLOSURE
clock_aggregates_through: FULLTIME-FLOW-CLOSURE
model_evaluation_through: FULLTIME-FLOW-CLOSURE
...
| | Duration |
|---|---:|
| Calendar span (first work → measurement) | 585h 37m |
| Unexplained stop (excluded) | 5h 16m |
| Active work (anything running) | ~184h est. |
| Sum of per-step agent time | ~181h 48m |
...
Session start: `2026-08-14 01:19 UTC`. Measurement: `2026-09-07T13:36:00Z`.
Recomputed 2026-09-07 at the FULLTIME-FLOW-CLOSURE acceptance
(Horizon v32 4/4): 201 accepted per-step rows summing to ~181h 48m (the new
objective adds ~2h 00m incl. the critic-RETRY cycle: builder ~65m /
critic ~32m / integration 22m / commit <1m). Calendar span recomputed from session start to this measurement. Long
