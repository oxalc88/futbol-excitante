...
const SCREENSHOT_DIR =
  "/home/ubuntu/projects/oxDeveloop/pes-simulator/docs/screenshots/SMALL-SIDED-INTEGRATED-PLAYTEST-MATCH";
const EVIDENCE_DIR =
  "/home/ubuntu/projects/oxDeveloop/pes-simulator/docs/evidence/SMALL-SIDED-INTEGRATED-PLAYTEST-MATCH";
    ...
    async () => {
      ...
      for (let fi = 0; fi < uniqueTicks.length; fi++) {
        ...
        await page.screenshot({
          path: `${SCREENSHOT_DIR}/frame-${frameLabels[fi]}.png`,
          type: "png",
        });
        tickIdx++;
      }
